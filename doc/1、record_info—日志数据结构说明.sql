...
CREATE TABLE IF NOT EXISTS cryptopia_history(
  id   BIGINT NOT NULL AUTO_INCREMENT COMMENT 'id',
  uid  VARCHAR (24) NOT NULL COMMENT '用户id',
  symbol VARCHAR (64) NOT NULL COMMENT '代币符号',
  price DOUBLE  NOT NULL COMMENT '金额',
  number DOUBLE NOT NULL COMMENT '数量',
  amount DOUBLE NOT NULL COMMENT '总量',
  fee DOUBLE NOT NULL COMMENT '手续费',
  type INT NOT NULL COMMENT '类型',
  trade_time BIGINT NOT NULL COMMENT '交易日期',
  PRIMARY KEY(id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE utf8_bin COMMENT '交易记录';
...
CREATE TABLE IF NOT EXISTS monitor_record(
  ...
  PRIMARY KEY(id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE utf8_bin COMMENT '监控记录';

CREATE TABLE IF NOT EXISTS monitor_symbol(
  id   BIGINT NOT NULL AUTO_INCREMENT COMMENT 'id',
  symbol VARCHAR (64) NOT NULL COMMENT '代币符号',
  exchange VARCHAR (64) NOT NULL COMMENT '交易所',
  sell_price DOUBLE  NOT NULL COMMENT '卖价',
  buy_price DOUBLE  NOT NULL COMMENT '买价',
  type INT NOT NULL COMMENT '交易类型',
  PRIMARY KEY(id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE utf8_bin COMMENT '监控币种';

CREATE TABLE IF NOT EXISTS exchange_api_result(
  id   BIGINT NOT NULL AUTO_INCREMENT COMMENT 'id',
  symbol VARCHAR (64) NOT NULL COMMENT '代币符号',
  exchange VARCHAR (64) NOT NULL COMMENT '交易所',
  result LONGTEXT NOT NULL COMMENT '内容',
  type INT NOT NULL COMMENT '类型',
  time BIGINT NOT NULL COMMENT '更新时间',
  PRIMARY KEY(id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE utf8_bin COMMENT 'ok接口信息';


CREATE TABLE IF NOT EXISTS photo_info(
  id   BIGINT NOT NULL AUTO_INCREMENT COMMENT 'id',
  uid VARCHAR (64) NOT NULL COMMENT '用户id',
  photo VARCHAR (128) NOT NULL COMMENT '图片地址',
  remark VARCHAR(256) NOT NULL COMMENT '备注',
  type INT NOT NULL COMMENT '类型',
  time BIGINT NOT NULL COMMENT '更新时间',
  PRIMARY KEY(id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE utf8_bin COMMENT '照片信息';
