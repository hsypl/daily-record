...
public enum CurrencyStateEnum {
    ...
    CurrencyStateEnum(Integer code, String description) {
        this.code = code;
     ...
     */
    public static CurrencyStateEnum valueOf(Integer code) {
        if (code != null) {
            for (CurrencyStateEnum typeEnum: values()) {
    ...
    public static List<CurrencyStateEnum> getEnumList() {
        List<CurrencyStateEnum> enumList = new ArrayList<>();
