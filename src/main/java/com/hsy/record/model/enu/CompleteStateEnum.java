...
public enum CompleteStateEnum {
    ...
    CompleteStateEnum(Integer code, String description) {
        this.code = code;
     ...
     */
    public static CompleteStateEnum valueOf(Integer code) {
        if (code != null) {
            for (CompleteStateEnum typeEnum: values()) {
    ...
    public static List<CompleteStateEnum> getEnumList() {
        List<CompleteStateEnum> enumList = new ArrayList<>();
