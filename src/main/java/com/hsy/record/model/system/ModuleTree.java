package com.hsy.record.model.system;
...
public class ModuleTree implements Serializable {
     ...
     */
    public MenuInfo getBelongsToMenu(String packageName) {
        String superPackageName = packageName;
        while (true) {
            MenuInfo menuInfo = getMenu(superPackageName);
            if (menuInfo != null) {
                return menuInfo;
            }
    ...
    public Map<Long,ModuleInfo> getModuleMap(){
        return moduleMap;
    }
}
